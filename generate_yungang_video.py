...
# 云冈石窟大佛 - 古代复原风 Prompt
PROMPT = """Northern Wei dynasty Yungang Grottoes colossal Buddha statue, the massive stone Buddha face slowly transforms from its current weathered grey-brown state to reveal original vivid painted colors — vermillion red lips, golden skin with lapis lazuli blue highlights in the ushnisha, elaborate floral patterns in gold leaf on the robe, colorful pigments of the 5th century AD Northern Wei dynasty appearing across the massive stone surface, divine golden light radiating from behind the Buddha head, dust particles floating in the warm light, slow cinematic zoom from full frontal view to close-up on the serene face, historical restoration of the original splendor, epic documentary style, 4K resolution"""

FILENAME = "yungang_buddha_historical"
